...
const sliderFakeData = [
  {
    ...
    images: {
      poster: 'https://example.com/images/hoa-hong-co-gai-poster.jpg',
      background: 'https://example.com/images/hoa-hong-co-gai-bg.jpg',
      thumbnail: 'https://example.com/images/hoa-hong-co-gai-thumb.jpg',
    },
    links: {
    ...
    >
      <SwiperSlide>
        <div
          ...
          style={{
            backgroundImage: 'url(https://static.nutscdn.com/vimg/1920-0/e16420e2ebceda97f1ba2c6bdba7fe1f.webp)',
          }}
        ></div>
        <div className="cover-fade">
          <div className="cover-image">
            <img
              ...
              loading="lazy"
              src="https://static.nutscdn.com/vimg/1920-0/0df1796bdad62348364c2f40e94c4ccc.webp"
            />
          </div>
        </div>
        ...
        <div className="subtitle pt-2 pb-2 text-[var(--primary-text)]" data-swiper-parallax="-200">
          The Roses
        </div>
        ...
        <div className="hl-tags pt-2 pb-2">
          <a className="tag-topic" href="/the-loai/chinh-kich.1gOywM">
            Chính Kịch
          </a>
          <a className="tag-topic" href="/the-loai/chieu-rap.3679nF">
            Chiếu Rạp
          </a>
          <a className="tag-topic" href="/the-loai/tinh-cam.4RxsoY">
            Tình Cảm
          </a>
          <a className="tag-topic" href="/the-loai/gia-dinh.8VSWst">
            Gia Đình
          </a>
          <a className="tag-topic" href="/the-loai/hai.W8Dn2a">
            Hài
          </a>
          <a className="tag-topic" href="/the-loai/lang-man.tvr5v7">
            Lãng Mạn
          </a>
        </div>
        <div className="text pt-2 pb-2" data-swiper-parallax="-100">
          <p>
            Cuộc sống của Ivy và Theo tưởng chừng hoàn hảo: sự nghiệp thành công, hôn nhân hạnh phúc, con cái ngoan
            ngoãn. Nhưng đằng sau lớp vỏ của một gia đình lý tưởng ấy là cơn bão ngầm đang dần hình thành — khi sự
            nghiệp của Theo tuột dốc trong khi tham vọng của Ivy thăng hoa, thổi bùng lên ngọn lửa ganh đua và oán giận
            âm ỉ có thể thiêu rụi tất cả.
          </p>
        </div>
        <div className="touch pt-2 pb-2">
          <a className="button-play" href="/xem-phim/hoa-hong-co-gai.WWGq5zxI">
